...
class RegistryServer(RegistryServer_pb2_grpc.RegistryServerServicer):
    ...
    def DeleteEntity(self, request: RegistryServer_pb2.DeleteEntityRequest, context):
        entity = self.proxied_registry.get_entity(
    ...
    def DeleteDataSource(
        ...
        data_source = self.proxied_registry.get_data_source(
            name=request.name, project=request.project
        )
        assert_permissions(resource=data_source, actions=[AuthzedAction.DELETE])
    ...
    def DeleteFeatureView(
        ...
        assert_permissions(resource=feature_view, actions=[AuthzedAction.DELETE])
    ...
    def ApplyFeatureService(
        ...
        assert_permissions(resource=feature_service, actions=CRUD)
    ...
    def DeleteFeatureService(
        ...
        assert_permissions(resource=feature_service, actions=[AuthzedAction.DELETE])
    ...
    def ApplySavedDataset(
        ...
        assert_permissions(resource=saved_dataset, actions=CRUD)
    ...
    def DeleteSavedDataset(
        ...
        assert_permissions(resource=saved_dataset, actions=[AuthzedAction.DELETE])
    ...
    def ApplyValidationReference(
        ...
        assert_permissions(resource=validation_reference, actions=CRUD)
    ...
    def DeleteValidationReference(
        ...
        assert_permissions(
            resource=validation_reference, actions=[AuthzedAction.DELETE]
        )
