...
from feast.constants import (
    ...
    OFFLINE_SERVER_HOST_ENV_NAME,
    OFFLINE_SERVER_PORT_ENV_NAME,
)
...
port = os.environ.get(OFFLINE_SERVER_PORT_ENV_NAME) or DEFAULT_OFFLINE_SERVER_PORT


host = os.environ.get(OFFLINE_SERVER_HOST_ENV_NAME) or "127.0.0.1"
